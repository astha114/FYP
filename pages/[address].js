...
export default function Detail({Data, DonationsData}) {
  ...
  useEffect(() => {
    const Request = async () => {
      ...
      fetch('https://fyphms.infura-ipfs.io/ipfs/' + Data.storyUrl)
      ...
      <LeftContainer>
        <ImageSection>
          <Image
            ...
            layout="fill"
            src={
              "https://fyphms.infura-ipfs.io/ipfs/" + Data.image
            }
          />
        </ImageSection>
        ...
        <DonateSection>
        <Funds>
            <FundText>{Data.title}</FundText>
        </Funds>
        </DonateSection>
      </LeftContainer>
      <RightContainer>
        <Title>Disease: {Data.requiredAmount}</Title>
        <Donated>
          <LiveDonation>
            <DonationTitle><Title>Diagnosis and Prescription</Title></DonationTitle>
            <Text>
          {story}
        </Text>
          </LiveDonation>
