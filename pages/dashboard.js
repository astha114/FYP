...
export default function Index({AllData, HealthData, EducationData,AnimalData}) {
    ...
    return (
      <HomeWrapper>
        ...
        <FilterWrapper>
          ...
          <Category onClick={() => setFilter(HealthData)}>Cardiologist</Category>
          <Category onClick={() => setFilter(EducationData)}>Dermatologist</Category>
          <Category onClick={() => setFilter(AnimalData)}>Physician</Category>
        </FilterWrapper>
          ...
          return (
            ...
            <CardImg>
              <Image 
                ...
                layout='fill' 
                src={"https://fyphms.infura-ipfs.io/ipfs/" + e.image} 
              />
            </CardImg>
            {/* <Title>
              {e.title}
  ...
  export async function getStaticProps() {
    ...
    const getHealthCampaigns = contract.filters.campaignCreated(null,null,null,null,null,null,'Cardiologist');
    ...
    const getEducationCampaigns = contract.filters.campaignCreated(null,null,null,null,null,null,'Dermatologist');
    ...
    const getAnimalCampaigns = contract.filters.campaignCreated(null,null,null,null,null,null,'Physician');
