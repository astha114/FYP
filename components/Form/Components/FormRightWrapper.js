...
const projectId = '2NHPoqUaFKSjpSJhk20OQHLsNCO'
const projectSecret = '83a5b51ea7ac27446b45b7d5dcf574eb'
    ...
    <FormRight>
      <FormInput>
        <FormRow>
          <RowFirstInput>
            <label>Disease</label>
            <Input onChange={Handler.FormHandler} value={Handler.form.requiredAmount} name="requiredAmount"  placeholder='Enter Disease'></Input>
          </RowFirstInput>
          <RowSecondInput>
